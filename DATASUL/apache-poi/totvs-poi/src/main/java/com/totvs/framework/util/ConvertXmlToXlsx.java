package com.totvs.framework.util;
...
public class ConvertXmlToXlsx {
	...
	private Map<String, Sheet> wsList = null;
	private Map<String, CellStyle> stList = null;

	public ConvertXmlToXlsx() { }
	 ...
	 * @throws Exception
	 */
	public Workbook readXmlData(Document doc) throws Exception {
        this.wb = null;
		this.wsList = new HashMap<String, Sheet>();
		this.stList = new HashMap<String, CellStyle>();
                                ...
                                if (celNode.getNodeType() == Node.ELEMENT_NODE) {
                            		...
                            		switch (dataType) {
                            			...
                            			case "number":
                                    		...
                                    		break;
                            			case "datetime":
                            				//Date ldt = Calendar.getInstance().setTimeInMillis(dataValue);
